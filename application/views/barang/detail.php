            ...
            <form action="<?= base_url('barang/create') ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nama_barang" id="nama_barang" autocomplete="off" value="<?= $res->nama_barang ?>" readonly>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="text" class="form-control" name="gambar" id="gambar" autocomplete="off" value="<?= $res->nama_kategori ?>" readonly>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="file" class="form-control" name="gambar" id="gambar" autocomplete="off" value="<?= $res->gambar ?>" readonly>
                            <img src="<?= base_url() ?>uploads/<?= $res->gambar ?>" alt="" class="img-fluid img-thumbnail">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea name="keterangan" id="keterangan" cols="30" rows="4" class="form-control" readonly><?= $res->keterangan ?></textarea>
